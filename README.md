...
| 🧑‍🎤 虚拟形象   | 像素角色精灵，支持站立/行走/泡澡/打架/蹲下/跳跃等多帧动画，脚下椭圆投影    |
| 🐾 AI 宠物     | 每个用户拥有 AI 宠物伙伴（7 种），战斗时在擂台外观战加油（各 20 句专属台词） |
| 💬 聊天系统      | 文字消息实时同步，角色头顶冒出对话气泡                        |
| ⚔️ 擂台格斗      | 帧模拟格斗引擎：蹲/跳/投技/必杀，垂直位移闪避，60 秒倒计时，KO 慢动作演出 |
| 💰 金币与观战下注  | 账户金币持久化；胜负增减币；`fight:start` 起 10 秒内非上场玩家可押攻/守（奖池派彩，平局/逃跑/强退全额退注） |
| 🧖 搓澡系统      | 点击王师傅搓澡快速回血（10HP/0.5s），78 句专属台词，排队机制       |
